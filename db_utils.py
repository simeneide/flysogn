...
if __name__ == "__main__":
    ...
    #%% add indexes
    if False:
        create_index_query = 'CREATE INDEX idx_time_name ON weather_measurements (time, name);'
    ...
    print(res)
    #%% test query
    res = db.execute_query("EXPLAIN SELECT * FROM weather_measurements where time > '2025-03-03 08:47:28'")
# %%
